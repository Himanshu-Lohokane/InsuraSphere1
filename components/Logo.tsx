  ...
  return (
    <div className={`flex items-center space-x-2 ${className}`}>
      ...
      >
        ...
        />
        <path
          d="M16 10C12.686 10 10 12.686 10 16C10 19.314 12.686 22 16 22C19.314 22 22 19.314 22 16C22 12.686 19.314 10 16 10ZM16 20C13.791 20 12 18.209 12 16C12 13.791 13.791 12 16 12C18.209 12 20 13.791 20 16C20 18.209 18.209 20 16 20Z"
          fill="currentColor"
        />
      </svg>
      <span className="text-xl font-bold text-blue-600">InsuraSphere</span>
    </div>
  );
};
